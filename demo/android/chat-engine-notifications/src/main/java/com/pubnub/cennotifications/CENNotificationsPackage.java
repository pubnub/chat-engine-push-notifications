package com.pubnub.cennotifications;
...
public class CENNotificationsPackage implements ReactPackage {
    ...
    public List<NativeModule> createNativeModules(ReactApplicationContext reactContext) {
        return  Collections.<NativeModule>singletonList(new CENNotifications(reactContext));
    }
}
