 ...
 * @discussion Chat engine plugin perform pre-formatting for messages which should be sent as push notifications, but it
 ...
 * WE GENERATE NOT ONLY FOR APNS... CHANGE DOCS!!!!!!!!!!!!!!!!!
...
/**
 * @brief Handle user interaction with notification's action buttons.
 *
